          ...
          <div className="md:hidden bg-white border-t border-gray-100 rounded-b-2xl">
            <div className="px-4 pt-2 pb-4 space-y-1">
              ...
              <div>
                ...
                {mobilePlatformOpen && (
                  <div className="pl-6 space-y-1 mt-1">
                    <Link to="/vsoc" className="block px-3 py-2 text-xs font-bold uppercase tracking-wider font-display text-gray-500 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Virtual SOC</Link>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                {mobileServicesOpen && (
                  <div className="pl-6 space-y-1 mt-1">
                    <Link to="/cyber-clinic" className="block px-3 py-2 text-xs font-bold uppercase tracking-wider font-display text-gray-500 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Cyber Clinic</Link>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                {mobileResourcesOpen && (
                  <div className="pl-6 space-y-1 mt-1">
                    <Link to="/blog" className="block px-3 py-2 text-xs font-bold uppercase tracking-wider font-display text-gray-500 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Security Blog</Link>
                    <Link to="/workshops" className="block px-3 py-2 text-xs font-bold uppercase tracking-wider font-display text-gray-500 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Workshops</Link>
                    <Link to="/classroom" className="block px-3 py-2 text-xs font-bold uppercase tracking-wider font-display text-gray-500 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Classroom</Link>
                  </div>
                )}
              </div>

              <Link to="/partners" className="block px-3 py-2 text-xs font-bold uppercase tracking-widest font-display text-gray-700 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">Partners</Link>
              <Link to="/about" className="block px-3 py-2 text-xs font-bold uppercase tracking-widest font-display text-gray-700 hover:text-[#D95D39] hover:bg-gray-50 rounded-md">About Us</Link>
